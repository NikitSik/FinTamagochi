...
namespace Tamagochi.Migrations
{
    ...
    [Migration("20250929221723_AddParrotCompanion")]
    partial class AddParrotCompanion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tamagochi.Models.Mission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 4,
                            Code = "INVEST_PARROT",
                            Description = "Запусти инвестиционную копилку и сделай первое пополнение",
                            ProductTag = "invest_piggy",
                            Repeatable = false,
                            RewardCoins = 350,
                            RewardPetId = "parrot",
                            RewardXp = 240,
