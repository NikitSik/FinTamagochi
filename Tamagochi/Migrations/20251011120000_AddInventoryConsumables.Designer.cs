...
namespace Tamagochi.Migrations
{
    ...
    [Migration("20251011120000_AddInventoryConsumables")]
    partial class AddInventoryConsumables
    {
            ...
            modelBuilder.Entity("Tamagochi.Models.PetStatus", b =>
                {
                    ...
                    b.Property<DateTime?>("LastHealedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Tamagochi.Models.ShopItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "med_kit",
                            Description = "+35 к здоровью",
                            Enabled = true,
                            PayloadJson = "{\"health\":35,\"mood\":5}",
                            Price = 35,
                            Title = "Аптечка",
                            Type = "medicine"
                        },
