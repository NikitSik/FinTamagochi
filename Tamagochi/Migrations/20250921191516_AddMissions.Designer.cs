...
namespace Tamagochi.Migrations
{
    ...
    [Migration("20250921191516_AddMissions")]
            ...
            modelBuilder.Entity("Tamagochi.Models.Mission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Description = "Накопи 1× месячных расходов (демо-цель) — импортируй выписку или нажми шаг",
                        ...
                        new
                        {
                            ...
                            Description = "Пройди мини-урок по антифроду (демо: кнопка 'пройдено')",
